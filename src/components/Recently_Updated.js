  ...
  return (
    <div className="text-[3rem] mt-[7rem] bg-[#171717] items-center justify-center flex flex-col  relative w-full h-[34rem]   text-white">
      ...
      >
          ...
          <div onClick={props.sweetRein} className="flex flex-col capitalize bg-[#2F2F2F] shrink-0 w-[13rem]  h-[21.5rem] max-[426px]:w-[11rem] max-[426px]:h-[18.7rem] overflow-hidden rounded-sm hover:scale-105 duration-100 justify-center items-center ">
            ...
            <div className=" flex flex-col  h-fit py-1 w-full px-3 items-center ">
              ...
              <p className="flex space-x-3 w-full  items-center text-gray-300 text-[0.8rem]">
                <span>TV </span>
                <FaCircle className="text-[0.4rem] text-gray-400" />
        ...
        <Link to="Player ">
          <div id="zom" className="flex flex-col capitalize bg-[#2F2F2F] shrink-0 w-[13rem]  h-[21.5rem] max-[426px]:w-[11rem] max-[426px]:h-[18.7rem] overflow-hidden rounded-sm hover:scale-105 duration-100 justify-center items-center ">
